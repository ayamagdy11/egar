					...
					<div class="col-sm-12">
						<div class="allMyAds">
							<div class="tPe">
								...
								<ul>
									<li><a href="<?php echo $this->config->base_url();?>egar/profileV" title="Grid"><i class="fa fa-th" aria-hidden="true"></i>Grid</a></li>
									<li><a href="<?php echo $this->config->base_url();?>egar/profile" title="List"><i class="fa fa-list" aria-hidden="true"></i>List</a></li>
								</ul>
							</div>
							<div class="clearfix"></div>
